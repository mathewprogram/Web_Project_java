...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form action="delete_by_id.jsp" method="post">
                <!-- Entry -->
                <div class="input-container">
                    Insert student id: <input type="text" name="txtId" size="2" maxlength="5" placeholder="id" value="<%= request.getParameter("txtId") != null ? request.getParameter("txtId") : ""%>" />
                ...
                <%
                    ...
                    if("Delete".equals(request.getParameter("btnDelete")) && id != null && !id.isEmpty()){
                    String idAlumno = request.getParameter("txtId");
                    alumno.deleteOne(Filters.eq("idAlumno", idAlumno));
                    out.println("Student eliminated.");
                    }
                    
                    if("Update".equals(request.getParameter("btnUpdate")) && id != null && !id.isEmpty()){
                    String idAlumno = request.getParameter("txtId");
                ...
                <table>
                    ...
                    <% if (edad != null && !edad.isEmpty() && !"No disponible".equals(edad)) {%>
                    <tr>
